...
public abstract class AbstractIntegrationTest {
    ...
    void truncateTables() {
        ...
        databaseClient.sql("TRUNCATE TABLE favourites, pending_files_uploads, sms_verification_codes, car_listing_analytics, car_listings, users RESTART IDENTITY CASCADE")
                .fetch()
                .rowsUpdated()
                .block();
    }
